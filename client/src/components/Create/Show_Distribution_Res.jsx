...
function Show_Distribution_Res() {
    const IndivisualEquip = [
        ...
        "沢日帰り装(1人1発): ザック、ザックカバー、シュラフカバー、登山靴、雨具(ゴアマ)、山シャツor ジャージ上、防寒具(フリースorセーター)、速乾性Tシャツ(ダクロンT)×2、靴下×2、地図(本、予備)、コンパス、マップケース、銀マット、ヘッドランプ、替え電池、テーピング、キジペ(トイレットペーパー)、笛、缶きり(1年)、非常用パック、タオル、帽子、時計、日焼け止め、お金、本審用紙(登山計画書)、学生証、保険証、遡行図、沢足袋、軍足(二本指靴下)、毛下、メット、ハーネス、カラビナ×3、確保器、80ロープ、120テープ、藪軍手、ポリタン×1、行動食2日分、非常食1日分、無洗米1合",
        "岩一般装: テープスリング*2、変形D型環付きカラビナ2 ハーネス、ヘルメット、クライミングシューズ、チョークバッグ、フリクションコード、セルフビレイコード、ビレイグローブ、テーピング、ヘッドランプ、atcガイド、hms型カラビナ、120テープスリング+180テープスリング、カラビナ３、缶きり(1年)、非常用パック、ポリタン×1、行動食2日分、非常食1日分、無洗米1合",
