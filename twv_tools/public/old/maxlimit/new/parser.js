var chart={
	window_setting:{x:0,y:0,zoom:1,fontsize:16,pin_radius:16,line_magnification:15},
	objects:{
...
function csvdata_to_chart(csvdata){
	...
	for(const v of nodes){
		tags.push({id:id_counter,value:v.Name,coord_type:"rel",rel_type:"nodes",rel_id:v.id,x:0,y:-30})
		id_counter++
	}
	...
	return {
		window_setting:{x:0,y:0,zoom:1,fontsize:16,pin_radius:16,line_magnification:8},
		objects:{
		nodes:nodes,
		links:links,
		tags:tags,
